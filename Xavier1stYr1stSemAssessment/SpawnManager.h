...
public:
	...
	void doggoSpawn(int &points, std::vector<doggo> &vector, std::vector<Boss2> &bossV);
	void ShitSpawn(int &counter, std::vector<doggo> &smVector, std::vector<bullets> &sVector, IngameSound &sound);
